...
enum class HttpStatusEnum private constructor(private val code: Int, private val reasonPhraseUS: String, private val reasonPhraseCN: String) {
  ...
  companion object {
    ...
    private val INFORMATIONAL = 1
    private val SUCCESSFUL = 2
    private val REDIRECTION = 3
    private val CLIENT_ERROR = 4
    private val SERVER_ERROR = 5
